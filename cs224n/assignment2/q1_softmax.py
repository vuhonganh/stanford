...
def cross_entropy_loss(y, yhat):
    ...
    ### YOUR CODE HERE
    # CE loss for one row = - \sum_i^{C}(y_i * log(y_hat)_i)  where C = n_classes
    ce = tf.to_float(y) * tf.log(yhat)  # element-wise product
    out = -tf.reduce_sum(ce)  # sum all over both axises
    ### END YOUR CODE
